...
class VitDepthMeanVarianceNetPlus(nn.Module):
    def __init__(self, input_channels, hidden_dim=256):
        super(VitDepthMeanVarianceNetPlus, self).__init__()
        ...
        # 全连接层
        self.fc_mean = nn.Linear(768+4, 1)  # ViT 输出特征维度为 768
        self.fc_variance = nn.Linear(768+4, 1)
...
if __name__ == "__main__":
    # 初始化模型
    input_channels = 8
    model = VitDepthMeanVarianceNetPlus(input_channels)
    ...
    save_path = "./base_ckpt_dir/dmvn_vit/dmvnp_origin.pth"
